  ...
  <div class="wrapper">
    ...
    if(isset($_POST['subscribe'])){ //if subscribe btn clicked
      ...
      if(filter_var($userEmail, FILTER_VALIDATE_EMAIL)){ //validating user email
        $subject = "Thanks for Subscribing us - ANIMAX anime made easy";
        $message = "Thanks for subscribing to our services. you will receive the latest info directly to your mail ~Team animax.You'll always receive updates from us. And we won't share and sell your information.";
        $sender = "From: logintome4games@gmail.com";
